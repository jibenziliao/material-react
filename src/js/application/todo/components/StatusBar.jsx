  ...
  render() {
    ...
    return (
      <div style={ barStyle }>
        ...
        <RaisedButton label="All" secondary={ this.props.filter === 'all' }
                      onClick={ this._changeFilter.bind(this, 'all') }/>&nbsp;&nbsp;&nbsp;&nbsp;
        <RaisedButton label="Active" secondary={ this.props.filter === 'active' }
                      onClick={ this._changeFilter.bind(this, 'active') }/>&nbsp;&nbsp;&nbsp;&nbsp;
        <RaisedButton label="Completed" secondary={ this.props.filter === 'completed' }
                      onClick={ this._changeFilter.bind(this, 'completed') }/>
        <FlatButton label="Clear completed" style={ this.state.clearStyle }
                    onClick={ this._cleanCompleted.bind(this) }/>
      </div>
    );
  }
}
